 ...
 */
class memberfile extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('project_id, street_id, file_id, file_size, username, mem_code ', 'required'),
			...
			array('project_id, street_id, sodowo, cnic, mobile, address, file_id, file_size, username, mem_code', 'safe', 'on'=>'search'),
		);
	}
	/**
