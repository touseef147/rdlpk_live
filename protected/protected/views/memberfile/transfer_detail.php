...
<div class="span6 left-box">
  ...
  <div class="">
	...
	<div class="black-bg">No. of Installment:</div><div class="grey-bg"><input type="text" readonly=readonly() style="height:16px;" name="noi" id="noi" value='.$key['insplan'].'></div>
...
<input type="hidden" name="plot_id" value="<?php echo $key['id']?>" />
<div class="float-left" >
    <p class="reg-left-text">Image<font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
    <?php echo' <img style="height:200px;" src="'.Yii::app()->request->baseUrl.'/images/imagetransfer/'.$key['image'].'">';?>
    <input id="image" type="file" name="image" accept="image/*">
  </p>
  </div>
<input type="file" name="image">
	<input type="submit" name="upload" class="btn" value="Upload"></form>
 
  </div>
     
   <form action="Crequest" method="post"  >
