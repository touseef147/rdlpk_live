...
?>
  <?php
            $res=array();
            foreach($filedetails as $key){
$imgesr=Yii::app()->baseUrl.'/upload_pic/'.$key['image'];
            echo '
<div class="span12" style="">

  <form action="submitstatus" method="post" onsubmit="return validateForm()" >
...
<div class="span6 left-box">
  ...
  <div class="">
    ...
    <input type="hidden" value='.$key['id'].' name="file_id" id="file_id" class="f-left span4 clearfix" /> <input type="hidden" value="'.$key['member_id'].'" name="member_id" id="member_id" class="f-left span4 clearfix" />
    ...
    <br>
 <input type="hidden" value='.$key['id'].' name="plot_id" id="plot_id" class="f-left span4 clearfix" />
...
$new_date = date('d-m-Y', $middle); 
  ...
  <div class="span5 left-box">
    ...
    <div class="black-bg">Request Date:</div>
    <div class="grey-bg"><?php echo $new_date  ?></div>
    <br>
    <div class="black-bg">User Name:</div>
    <div class="grey-bg"><?php echo $key['firstname']  ?></div>
    <br>
  ...
  <div class="span5 left-box">
    ...
    <div class="black-bg">Finance User Status:</div>
    <div class="grey-bg">
        <?php if($key['fstatus']=='approved' ){ echo'Verified';} else{echo $key['fstatus']; } ?></div>
    <br>
     <div class="black-bg">Comments:</div>
    <div class="grey-bg">
        <?php echo $key['fcomment'];  ?></div>
    <br>
  </div>
  <div class="span5 left-box">
  ...
  <div class="bot-box" style="width:600px;">
    ...
    width: 300px;"> <span style="color:#FF0000; display:block;" id="error-statusapp"></span> <span style="color:#FF0000;display:block;" id="error-cmnt"></span> </div>
    </form>
    <?php } ?>
  </div>
  <div class="clearfix"></div>
