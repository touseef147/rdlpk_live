...
{
echo 'Project Name:'.$ro['project_name']; 
}
echo $_POST['project'];
?> 
...
$sql_plots  = "SELECT DISTINCT size2 FROM plots";
...
$total=0;
echo '<tr><td>'.$row1['size2'].'</td>';
	$sql_plots1  = "SELECT * from plots where size2='".$row1['size2']."' AND com_res='Residential' and project_id='".$_POST['project']."'";
...
echo '<td class="bgd"><b></b></td>';
echo '<td class="bgd"><b>'.$t_f_allotedn.'%</b></td>';
echo '<td class="bgd"><b>'.$t_p_allotedn.'%</b></td>';
echo '<td class="bgd"><b>'.$to_remn.'%</b></td>';	
echo '<td class="bgd"></td></tr>';	
 ?>
