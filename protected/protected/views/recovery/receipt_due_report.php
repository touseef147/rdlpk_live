...
<script>	
 ...
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/recovery/search_receipt_vs_due_graph",
                  type:"POST",
...
<div class="shadow">
  <h3>Receipt vs Due Graphical Reports</h3>
</div>
...
?>
 ...
 'enableAjaxValidation'=>false,
  ...
  <?php echo CHtml::ajaxSubmitButton(
     ...
     array('recovery/search_receipt_vs_due_graph/?page=1'),
