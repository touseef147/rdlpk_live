...
<script>	
 ...
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/recovery/searchblock123",
                  type:"POST",
...
<div id="" class="errorMessage" style="display: none; color:#F00; font-weight:bold;"></div>
 ...
 <input type="text" value="" style="width:160px" name="name1" id="name1" class="new-input" placeholder="Enter Name" />
...
<option value="4">Blocked</option><?php }?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
     ...
     array('recovery/searchblock123/?page=1'),
