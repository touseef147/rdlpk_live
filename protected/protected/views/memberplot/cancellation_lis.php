...
<script>	
 $(function(){
	  ...
	  var stat=2;	
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/memberplot/cancellationreq",
                  type:"POST",
...
<option value="3" >Approved</option>
 ...
 <?php echo CHtml::ajaxSubmitButton('Search',array('cancellationreq?page=1'), array( 'beforeSend' => 'function(){ 
