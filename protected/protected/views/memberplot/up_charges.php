...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 'enableAjaxValidation'=>false,
  ...
  <div class="float-left">
    ...
    <p class="reg-right-field-area margin-left-5">
      <input type="text" value="<?php echo $pay['discount'];?>" name="discount" id="discount" class="reg-login-text-field" />
    </p>
  </div>
  <div class="float-left">
    <p class="reg-left-text">Discount Details. <font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
      <input type="text" value="<?php echo $pay['disdetails'];?>" name="disdetails" id="disdetails" class="reg-login-text-field" />
    </p>
  </div>
