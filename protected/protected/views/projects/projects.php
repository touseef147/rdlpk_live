...
<div class="float-left">
    ...
    <p class="reg-left-text">Project URL <font color="#FF0000">*</font></p>

    <p class="reg-right-field-area margin-left-5">

      <input type="text" value="" name="url" id="url"  class="form-control" placeholder="Enter URL" />
...
<option value="0">inActive</option>
    ...
    <div class="float-left" >
    <p class="reg-left-text">Project Map<font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
    <input id="image" type="file" name="map" accept="image/*">
  </p>
  </div>
