...
<div class="float-left">
    ...
    <?php	
            ...
            echo '<tr><td></td><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td><td>'.$key['teaser'].'</td><td>'.$key['details'].'</td><td><img src="'.Yii::app()->request->baseUrl.'/images/upload/'.$key['project_image'].'"></td><td>'.$key['create_date'].'</td><td><a href="'.Yii::app()->request->baseUrl.'/index.php/projects/update_project?id='.$key['id'].'">Edit</a></td></tr>'; 
            }?>
</table> 			
