...
<script>	
 $(function(){
	  var project_name=$("#project_name").val();
	   var stat=1;	
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/dealer/searchreq1",
                  type:"POST",
...
<select name="project_name" id="project_name" style="width:150px;">
<?php	
            foreach($projects as $key){
            echo '<option value="'.$key['id'].'">'.$key['project_name'].'</option>'; 
            }?></select> 

<select name="ty" id="ty" style="width:150px;">
<option value="">Select Type</option>
<option value="1">Res</option>
<option value="2">Com</option>   </select>
...
<option value="2">Awaited Submission</option>
 ...
 <?php echo CHtml::ajaxSubmitButton(
     ...
     array('dealer/searchreq1/?page=1'),
