<div class="">
<div class="shadow">
  <h3>Assign Forms To Finance Administrator</h3>
</div>
<!-- shadow -->
...
<div id="error-div" class="errorMessage" style="display: none; color:#F00;"></div>
  ...
  <div class="float-left">
    <p class="reg-left-text">Finance User<font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
     <select name="fuser_id" id="fuser_id"><?php	
