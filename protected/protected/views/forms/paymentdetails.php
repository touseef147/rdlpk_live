...
<div class="abc">Paid Date:</div><b><?php echo $sp.$plo['paid_date'].'<br>';?></b>
<div class="abc">Amount:</div><b><?php echo $sp.$plo['paidamount'].'<br>';?></b>
<div class="abc">Paid As:</div><b><?php echo $sp.$plo['paidas'].'<br>';?></b>
...
$sts='';
$sns='';
if($plo['ftype']=='membership'){$sns='fsfstatus';};
if($plo['ftype']=='certificate'){$sns='ocfstatus';};
if($plo['ftype']=='booking'){$sns='tmfstatus';};
if($plo[$sns]==1){$sts='Approved';}
if($plo[$sns]==2){$sts='On Hold';}
if($plo[$sns]==3){$sts='Rejected';} ?>
