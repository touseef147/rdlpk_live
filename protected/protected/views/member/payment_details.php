...
echo'<a href="up_charges?pid='.$_REQUEST['pid'].'&&id='.$row['id'].'&&mem_id='.$mem['member_id'].'">Edit</a>/ <a href="update_charges?pid='.$_REQUEST['pid'].'&&id='.$row['id'].'&&mem_id='.$mem['member_id'].'">Pay</a>';
}
echo '</td></tr>	';} 
...
<table class="table table-striped table-new table-bordered">
            	...
            	<thead   style=" visibility:hidden;background:#666; border-color:#ccc; color:#666; ">
<tr>
...
<td colspan="2"><b>Grand Total(PKR):</b></td>
...
echo '<tr><td colspan="2"><b>%age Outstanding</b></td><td></td><td></td><td></td><td style="text-align:right;"><b>'.number_format($percentage).'%'.'</b></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
?></tbody></table>
