...
<div class="shadow">
  ...
  <h3>User Account Activate Detail</h3>
...
<?php	
            ...
            foreach($ua_activate_detail as $key){
...
<div class="span12" style="">
  ...
  <div class="">
  	...
  	<div class="black-bg">User Name:</div><div class="grey-bg">'.$key['name'].'</div><br>
...
<span><a href="<?php echo Yii::app()->request->baseUrl ?>/index.php/user/mail_unregister_user?id=<?php echo $key['id'];?>">Reply</h5></a></span>
