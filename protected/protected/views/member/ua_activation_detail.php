...
<div class="shadow">
  ...
  <h3>Member Account Activation Detail</h3>
...
<?php	
            ...
            foreach($visitor_query_detail as $key){
...
<span><a href="<?php echo Yii::app()->request->baseUrl ?>/index.php/member/ua_send_mail?mid=<?php echo $_REQUEST['mid'];?>&&id=<?php echo $key['id'];?>">Reply</h5></a></span>
