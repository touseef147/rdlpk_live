...
$test_files = glob("dompdf/www/test/*.{".implode(",", $extensions)."}", GLOB_BRACE);
$sections = array(
  "css"      => array(), 
  "dom"      => array(), 
  "image"    => array(), 
...
$dompdf .= "dompdf/dompdf.php?base_path=" . rawurlencode("/dompdf/www/test/");
...
foreach ( $sections as $section => $files ) {
  ...
  foreach ( $files as $file ) {
    ...
    echo " 
  [<a class=\"button\" target=\"preview\" href=\"dompdf/www/test/$filename\">HTML</a>] 
