...
<script>	
 $(function(){
	  ...
	  var stat=2;	
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/memberplotsales/transferreq",
                  type:"POST",
...
<option value="3" >Approved</option>
 ...
 <?php echo CHtml::ajaxSubmitButton('Search',array('transferreq?page=1'), array( 'beforeSend' => 'function(){ 
    ...
    <p class="reg-left-textResult For"></p>
            ...
            <table class="table table-striped table-new table-bordered">
            	...
            	<thead style="background:#666; border-color:#ccc; color:#fff; font-size:12px;">
                    ...
                    <tr>
						<th width="8%">MS #</th>
                        <th width="10%" colspan="2">Seller</th>
                        <th width="10%" colspan="2">Purchaser</th>
