...
<body>
<div style="margin:80px 0 0 60px; position:absolute;"><?php if($member['type']=='file'){  echo $member['plot_detail_address']; }else{ echo'';}
?></div>
...
<div id="applicant_name" style="margin:490px 0 0 620px; position:absolute;"><?php echo date('d-m-Y');  	 ?></div>
<div id="email" style="margin:585px 0 0 160px; position:absolute; font-weight:bold;"><?php echo $member['name']; 	 ?></div>
<div id="plotid" style="margin:585px 0 0 525px; position:absolute;"><?php  if($member['type']=='Plot'){  echo $member['plot_detail_address']; }else{ echo'--';} 	 ?></div>
<div id="email" style="margin:615px 0 0 200px; position:absolute;"><?php echo $member['sodowo']; 	 ?></div>
<div id="email" style="margin:615px 0 0 525px; position:absolute;"><?php echo $member['sector_name'].'/'.$member['street']; 	 ?></div>
...
<body>
<div style="margin:80px 0 0 60px; position:absolute;">
<?php  if($member['type']=='file'){  echo $member['plot_detail_address']; }else{ echo'';}?>
</div>
<div id="profile" style="margin:80px 0 0 60px; position:absolute;"><?php if($member['type']=='file'){  echo $member['plot_detail_address']; }else{ echo'';}  ?></div>

<div id="profile_pic" style="margin:345px 0 0 100px; position:absolute;"><img src="<?php echo Yii::getPathOfAlias('webroot')."/upload_pic/".$member['image'];  ?>" width="100px" height="115px"></div>
<div id="applicant_name" style="margin:500px 0 0 225px; position:absolute; font-weight:bold;"><?php echo $member['plotno']; 	 ?></div>
<div id="applicant_name" style="margin:500px 0 0 620px; position:absolute; font-weight:bold;"><?php echo date('d-m-Y');  	 ?></div>
<div id="email" style="margin:595px 0 0 160px; position:absolute; font-weight:bold;"><?php echo $member['name']; 	 ?></div>
<div id="plotid" style="margin:595px 0 0 525px; position:absolute;"><?php if($member['type']=='Plot'){  echo $member['plot_detail_address']; }else{ echo'--';}  	 ?></div>
<div id="email" style="margin:625px 0 0 200px; position:absolute;"><?php echo $member['sodowo']; 	 ?></div>
<div id="email" style="margin:625px 0 0 525px; position:absolute;"><?php echo $member['sector_name'].'/'.$member['street']; 	 ?></div>
...
<div id="applicant_name" style="margin:220px 0 0 655px; position:absolute;"><?php echo date('d-m-Y'); 	 ?></div>
...
<div id="email" style="margin:632px 0 0 568px; position:absolute;"><?php echo $member['sector_name']; 	 ?></div>
