...
<div class="shadow">
  <h3>Property Alottment Request</h3>
</div>
<!-- shadow -->
...
<div class="span12" style="">
 	<div class="black-bg">Project Name:</div><div class="grey-bg"><input type="text" style="height:16px;" readonly=readonly() name="project_name" id="project_name" value="'.$key['prname'].'"></div>
<div class="black-bg">property type:</div><div class="grey-bg"><input type="text" readonly=readonly() style="height:16px; " name="com_res" id="com_res" value="'.$key['project_name'].'"></div>
<div class="span6 left-box">
  ...
  <div class="">
	...
	<div class="black-bg">property info:</div><div class="grey-bg"><input type="text" readonly=readonly() style="height:16px;" name="plot_detail_address" id="plot_detail_address" value="'.$key['pname'].'"></div><br>
    ...
    <input type="hidden" value='.$key['id'].' name="plot_id" id="plot_id" class="f-left span4 clearfix" /> <input type="hidden" value="'.$key['member_id'].'" name="member_id" id="member_id" class="f-left span4 clearfix" />
  	...
  	<div class="black-bg">Floor:</div><div class="grey-bg"><input type="text" style="height:16px;" name="street" id="street" readonly=readonly() value="'.$key['floors'].'"></div>

    <br>

  	<div class="black-bg">Covered Area:</div><div class="grey-bg"><input type="text" style="height:16px;" name="plot_size" readonly=readonly() id="plot_size" value="'.$key['carea'].'"></div>
...
$new_date = date('d-m-Y', $middle); 
   ...
   <div class="clearfix"></div>
    ...
    <div class="black-bg">Cost Of Plot:</div><div class="grey-bg"><?php echo $key['price'];  ?></div><br>
     <div class="black-bg">Installment:</div><div class="grey-bg"><?php echo $key['insplan'];  ?></div><br>
...
<div class="span5 left-box">
    ...
    <div class="black-bg"> Status:</div><div class="grey-bg"><?php echo $key['fstatus'];  ?></div><br>
    <div class="black-bg"> Comment:</div><div class="grey-bg"><?php // echo $key['fcomment'];  ?></div><br>
    </div>
...
<option value="Rejected">Rejected</option>
    ...
    <label><h5>Comment By Administrator</h5></label>
  	...
  	<input name="submit" type="submit" value="Submit" class="btn-info pull-right" style="padding:5px 10px; float:left; clear:both; border:1px solid #fff;" />
