...
echo '<tr><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td><td>'.$key['size'].'</td><td>'.$key['description'].'</td><td>'.$key['tno'].'</td><td style="text-align:right;">'.$key['tamount'].'</td><td><a target="_blank" href="'.Yii::app()->request->baseUrl.'/index.php/property/updateinstall?id='.$key['id'].'">Edit</a><a  href="'.Yii::app()->request->baseUrl.'/index.php/property/Delete?id='.$key['id'].'">/Delete</a></td></tr>';
}?>
