...
<span style="float:right"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/uprojects/uprojects"  class="btn-info button">Add New Project</a></span>
</div>
  <h3>Upcoming Project List</h3>
</div>
<!-- shadow -->
...
<div class="">
    ...
    <?php	
            ...
            echo '<tr><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td><td>'.$key['teaser'].'</td><td>'.$key['create_date'].'</td><td><a href="'.Yii::app()->request->baseUrl.'/index.php/uprojects/detail_uproject?id='.$key['id'].'">Detail</a><a href="'.Yii::app()->request->baseUrl.'/index.php/uprojects/update_uproject?id='.$key['id'].'">/Edit</a><a href="'.Yii::app()->request->baseUrl.'/index.php/uprojects/Delete_uproject?id='.$key['id'].'">/Delete</a></td></tr>'; 
            }?>
</table> 			
