...
<span style="float:right"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/uprojects/uproject_list"  class="btn-info button">Project List</a></span>
</div>
  <h3>Project List</h3>
</div>
<!-- shadow -->
...
<div class="float-left">
    ...
    <?php	
            ...
            echo '<tr><td></td><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td><td>'.$key['teaser'].'</td><td>'.$key['details'].'</td><td><img src="'.Yii::app()->request->baseUrl.'/images/uprojects/'.$key['project_image'].'"></td><td>'.$key['create_date'].'</td><td><a href="'.Yii::app()->request->baseUrl.'/index.php/uprojects/update_uproject?id='.$key['id'].'">Edit</a></td></tr>'; 
            }?>
</table> 			
