...
<?php	
            ...
            echo '<tr><td> File Membership #:</td><td>'.$key['plotno'].'</td></tr><tr><td> File No:</td><td>'.$key['plot_detail_address'].'</td></tr><tr><td>Street No:</td><td>'.$key['street'].'</td></tr><tr><td>Project Name</td><td>'.$key['project_name'].'</td></tr><tr><td> Create Date:</td><td>'.$key['create_date'].'</td></tr>
