...
<div id="applicant_name" style="margin:490px 0 0 620px; position:absolute;"><?php echo $member['create_date'];  	 ?></div>
...
<div id="email" style="margin:462px 0 0 450px; position:absolute;"><?php echo $member['sector']; 	 ?></div>
</body>
</html>
</textarea>
    <div style="text-align: left; margin-top: 1em;">
...
<div id="email" style="margin:313px 0 0 525px; position:absolute;"><?php echo $member['sector']; 	 ?></div>
