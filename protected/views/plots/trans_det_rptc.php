<div class="shadow">
  <h3>Transferred Detail Report (Commercial)</h3>
</div>
           <?php
...
<section class="reg-section margin-top-30">
  ...
  <div class="float-left">
	...
	Left JOIN memberplot ON (transferplot.plot_id = memberplot.plot_id)
	 where plots.project_id='".$_GET['project']."' and plots.size2='".$_GET['sizeid']."' and plots.com_res='Commercial'";
