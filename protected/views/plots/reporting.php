...
<input type="submit" name="trnsferfiles" value="Transferred Files" class="span4 main-icons" class="btn btn-primary btn-lg" />
...
<input type="submit" name="deulist" value="Due charges & installment" class="span4 main-icons" class="btn btn-primary btn-lg" />
<input type="submit" name="memadrept" value="Member Address Report" class="span4 main-icons" class="btn btn-primary btn-lg" />
