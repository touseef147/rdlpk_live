...
$_REQUEST['pid']=0;?>
<div class="shadow">
   <h3>Installment Details<a href="installment_details?id=<?php echo $_REQUEST['id'] ?>&&pid=<?php echo $_REQUEST['pid'] ?>" class="btn" style="float:right;">Exit Edit Mode</a></div></h3>
...
$i++;
  ...
  echo '<tr><td><input value="'.$pay['lab']. '" name="lab[]" '.$status.'/></td>
	<input type="hidden" value="'.$pay['id']. '" name="ppid[]" />
	<input type="hidden" value="'.$_REQUEST['id']. '" name="ploid" />
     <td><input value="'.$pay['due_date'].'" name="due_date[]"  id="todatepicker" '.$status.'/></td>
     <td><input value="'.$pay['paid_date'].'" name="paid_date[]"  id="fromdatepicker" '.$status.'/></td>
     <td style="text-align:right"><input value="'.$pay['dueamount'].'" name="dueamount[]" '.$status.'/></td>
     <td style="text-align:right"><input value="'.$pay['paidamount'].'" name="paidamount[]"  '.$status.'/></td>
     <td><input value="'.$pay['payment_type'].'" name="payment_type[]"  '.$status.'/></td>
     <td><input value="'.$pay['detail'].'" name="detail[]"  '.$status.'/></td>
     <td align="right"><input value="'.$pay['surcharge'].'" name="surcharge[]"  '.$status.'/></td>
	 <td align="right"><input value="'.$pay['paidsurcharge'].'" name="paidsurcharge[]" '.$status.'/></td>
     <td><input value="'.$pay['remarks'].'" name="remarks[]"  '.$status.'/></td>
     <td><input value="" name="" id="" /></td></tr>
...
';
  ...
  </table><input type="submit" name="Update plan" value="Update plan" class="btn" />
    </form>
 <a class="btn" href="addins?id=<?php echo $_GET['id']; ?>&&mid=<?php echo $mid; ?>&&pid= <?php echo $_GET['pid']; ?>">Add New installment</a>
</section>
</div>
...
<input style="float:left;" type="submit" name="submit" value="Print Report" class="btn"/></form>
<hr noshade="noshade" class="hr-5">
<hr noshade="noshade" class="hr-5">
<hr noshade="noshade" class="hr-5">
<hr noshade="noshade" class="hr-5">
