<style>
.black-bg {
	background:#333; color:#fff; width:24%; float:left; padding:5px 10px; margin:2px 0px;
	}
.grey-bg {
...
<div class="black-bg">Allotment Type:</div><div class="grey-bg"><input type="text" readonly=readonly() style="height:16px; " name="com_res" id="com_res" value="'.$key['atype'].'"></div>
...
<div class="span6 left-box">
  ...
  <div class="">
	...
	<div class="black-bg">Plot No.:</div><div class="grey-bg"><input type="text" readonly=readonly() style="height:16px;" name="plot_detail_address" id="plot_detail_address" value="'.$key['plot_detail_address'].'"></div><br>
    ...
    <input type="hidden" value='.$key['id'].' name="plot_id" id="plot_id" class="f-left span4 clearfix" /> <input type="hidden" value="'.$key['member_id'].'" name="member_id" id="member_id" class="f-left span4 clearfix" />
  	...
  	<div class="black-bg">Plot Address:</div><div class="grey-bg"><input type="text" style="height:16px;" name="street" id="street" readonly=readonly() value="'.$key['street'].'/'.$key['sector_name'].'"></div>
...
$new_date = date('d-m-Y', $middle); 
   ...
   <div class="clearfix"></div>
    ...
    <div class="black-bg">User Name:</div><div class="grey-bg"><?php echo $key['firstname'].'&nbsp'.$key['middelname'].'&nbsp'.$key['lastname'];  ?></div><br>
    <div class="black-bg"> Email:</div><div class="grey-bg"><?php echo $key['email']?></div><br>
    </div>  
<div class="span5 left-box">
    <h5 style="text-align:left;">Finance User Status:</h5>
    <div class="black-bg"> Status:</div><div class="grey-bg">
    <?php if($key['fstatus']=='approved' ){ echo'Verified';} else{echo $key['fstatus']; } ?></div><br>
    <div class="black-bg"> Comments:</div><div class="grey-bg"><?php echo $key['fcomment'];  ?></div><br>
    </div>
  <div class="span5 left-box">
    <h5 style="text-align:left;">Payment Details Link:</h5>
    <div class="black-bg">Link:</div>
    <div class="grey-bg"> <a href="<?php echo $this->createAbsoluteUrl('memberplot/payment_details?id='.$key['id'].'')?>">Payment Detail Link</a></div>
    <br>
  </div>
