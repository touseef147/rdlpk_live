...
<script>	
 ...
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/memberplot/searchreq",
                  type:"POST",
...
<div class="shadow">
  ...
  <h3>Member Plots</h3>
 <?php if((Yii::app()->session['user_array']['per33']=='1')&& isset(Yii::app()->session['user_array']['username'])){ ?><h5 style="float:right;"><a href="cancelled_plots">Cancelled Plots</a></h5><?php }?>
</div>
...
<option value="4">Blocked</option><?php }?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
     ...
     array('memberplot/searchreq/?page=1'),
