...
<script>
 ...
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/memberplot/searchreqf",
                  type:"POST",
...
<div class="shadow">
  ...
  <?php if((Yii::app()->session['user_array']['per33']=='1')&& isset(Yii::app()->session['user_array']['username'])){ ?><h5> <a style="float:right" href="cancelled_files">Cancelled Files</a></h5><?php }?>
...
<?php echo CHtml::ajaxSubmitButton(
    ...
    array('memberplot/searchreqf/?page=1'),
