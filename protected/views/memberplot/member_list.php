...
<form action="member_lis" method="post"> 
  <div class="clear-fix"></div>
    ...
    <input type="text" value="" name="plot_size" id="plot_size" class="new-input" placeholder="Plot Size" />
    <input type="text" value="" name="project_name" id="project_name" class="new-input" placeholder="Project Name" />
    <input type="text" value="" name="plot_detail_address" id="plot_detail_address" class="new-input" placeholder="Plot Address" />
