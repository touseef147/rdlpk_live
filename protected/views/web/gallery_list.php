...
<div class="float-left">
    ...
    <?php	
            ...
            echo '<tr><td>'.$key['id'].'</td><td>'.$key['title'].'</td><td>'.$key['description'].'</td><td><a href="'.Yii::app()->request->baseUrl.'/index.php/web/view_gallery?id='.$key['id'].'&title='.$key['title'].'">Detail</a></td></tr>'; 
            }?>
</table> 			
