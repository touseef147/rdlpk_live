...
if (isset($_POST["upload"])) { 
	...
	if (strlen($error)==0){
		...
		if (isset($_FILES['image']['name'])){
			...
			$sql="UPDATE members SET image='$thumb_image_name' WHERE id=$session";
...
<head>
	...
	<title>Upload Member Image</title>

	

	<script type="text/javascript" src="http://localhost/hb/js/jquery-pack.js" ></script>

	<script type="text/javascript" src="http://localhost/hb/js/jquery.imgareaselect-0.3.min.js"></script>
