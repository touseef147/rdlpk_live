...
<!--<a href="visitor_query1" class="btn pull-right" style="padding:5px; margin-left:10px; ">Previous Queries</a>-->
  ...
  <h3>Member Account Activation Requests</h3>
...
$count=1;
			...
			echo'</td><td >';if($key['replied']=='1'){
				...
				}else{echo '<strong style="color:red">Not Replied</strong>';} echo'<td><a href="ua_activation_detail?id='.$key['id'].'&& mid='.$key['mid'].'">Detail</a>/<a href="ua_activate_delete?id='.$key['id'].'">Delete</a></td></tr>'; 
$count++;
            }?>
