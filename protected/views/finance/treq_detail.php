...
$sql_install  = "SELECT * FROM installpayment where plot_id=".$key['plot_id']." AND others!='Cancelled' AND fstatus!='Cancelled'";
...
echo '</tbody></table>';?>
    ...
    <div class="tab-pane" id="2">
      <p><h5>Installment Details</h5>
        <?php
		$connection = Yii::app()->db;
		$land  = "SELECT * FROM installpayment where plot_id='".$ppid."' and paidamount!='' and mem_id='".$memmm."' AND others!='Cancelled' AND fstatus!='Cancelled'";
		$land_cost = $connection->createCommand($land)->queryAll();
