...
<div class="float-left">
    <p class="reg-right-field-area margin-left-5">
     <table class="table-striped table-bordered table span12"><thead>
     	<th>
            ...
            <td style="width:10%;"><b>Project Code</b></td>
    ...
    <?php	
            ...
            echo '<tr><td></td><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td><td>'.$key['code'].'</td><td>'.$key['teaser'].'</td><td>'.$key['details'].'</td><td><img src="'.Yii::app()->request->baseUrl.'/images/upload/'.$key['project_image'].'"></td><td>'.$key['create_date'].'</td><td><a href="'.Yii::app()->request->baseUrl.'/index.php/projects/update_project?id='.$key['id'].'">Edit</a></td></tr>'; 
            }?>
</table> 			
