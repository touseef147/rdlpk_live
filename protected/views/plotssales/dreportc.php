<div class="shadow">
  <h3>Detail Report<b> ::Commercial</b></h3>
</div>
           <?php
...
foreach($result_plots as $row1){
	...
	Left JOIN streets ON (plots.street_id = streets.id)
	 where com_res='Commercial' and plots.project_id='".$_POST['project']."' and size2='".$row1['id']."'";
...
foreach($result as $ro)
{
echo '<b><p>Project Name:</b>'.$ro['project_name'].'</p>'; 
}
?>
  <div class="float-left">
          <?php
