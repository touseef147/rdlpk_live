...
<div class="panel panel-default">
 <div class="panel-body">
  ...
  <!-- Table -->
  <?php if(!isset($key['atype'])){$key['atype']=0;}?>
...
<div class="span6" style="float:left">
  ...
  <h5 style="text-align:left;">Transfer From (Transferor) </h5>	</th>
     <tr><td rowspan="7" style="width:100px;" ><?php if(empty($result_details1['image'])){ echo'<img style="border-radius:200px;" width="140px" src="'.Yii::app()->baseUrl.'/upload_pic/profile-icon.png'.'"/>'; }else{ echo '<img style="border-radius:200px;" width="140px" src="'.$imges.'"/>';}?></td></tr>
    <tr><td>MS No.</td><td class="td1"><?php echo $key['plotno'];?></td></tr>
...
<div class="span6">
  ...
  <h5 style="text-align:left;">Transfer To (Transferee)</h5>	</th>
      <tr><td rowspan="7" style="width:100px;" ><?php if(empty($result_details['image'])){ echo'<img style="border-radius:200px;" width="140px" src="'.Yii::app()->baseUrl.'/upload_pic/profile-icon.png'.'"/>'; }else{ echo '<img style="border-radius:200px;" width="140px" src="'.$imgesr.'"/>';}?></td></tr>
    <tr><td>MS No.</td><td class="td1"><?php echo $key['plotno'];?></td></tr>
  ...
  <div class="tab-content">
    ...
    <tr><td>Request Date:</td><td><?php echo $new_date  ?></td></tr>
     ...
     <tr><td>Email.:</td><td><?php echo $key['email'] ;?></td></tr> 
      ...
      <div>
    <table class="table"> <?php $home=Yii::app()->request->baseUrl.'/index.php' ?>
    <tr><td colspan="2"><h5 style="text-align:left;">Finance User Status:</h5></td></tr>
     <tr><td style="width:10%;">Comment:</td><td><?php echo $key['fcomment'];  ?></td></tr>
     <tr><td>Status:</td><td><?php
     if($key['fstatus']=='Approved'){ echo'Verified';}else{ echo $key['fstatus']; }?></td></tr>
