...
<div class="shadow">
  ...
  <h3>Advance Search:Subdealer</h3>
...
<span style="float:right"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/seller/sdealer"  class="btn-info button">Add New Sub Dealer</a></span>
