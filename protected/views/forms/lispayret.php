...
<script>	
 ...
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/forms/Financereqret",
                  type:"POST",
    ...
    $('#error-div').on('click','.page-numbers',function(){
	   ...
	   $.ajax({
	     url:"http://<?php echo $address ?>/index.php/forms/Financereqret",
                  type:"POST",
                  data:"actionfunction=showData&page="+$page+"&&type=<?php echo $type?>",
        cache: false,
        success: function(response){
		  $('#error-div').html(response);
		}
...
<div class="shadow">
  ...
  <h3>Returned Payments <span style="font-size:12px;">(<?php echo $_REQUEST['type']; ?>)</span></h3>
...
?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
    ...
    array('/forms/Financereqret?type='.$type.'&page=1'),
            	...
            	<thead style="background:#666; border-color:#ccc; color:#fff;">
                    ...
                    <tr>
                        ...
                        <th width="10%">App's Name </th>
                         <th width="6%">CNIC</th>
                        <th width="7%" >Returned Amount</th>
                        <th width="7%">Payment Mode</th>
                         <th width="7%">Reference</th>
                        <th width="8%">Returned Date</th>
