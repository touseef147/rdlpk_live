...
/*background-image: url('<?php //echo Yii::app()->baseUrl; ?>);
...
<div style="font-family:segoepr; margin:60px 0 0 205px; position:absolute; font-size:12px; font-weight:bold; "><?php //echo $plo['code'].'-'.$plo['formno'];?></div>

<div style="font-family:segoepr; margin:360px 0 0 120px; position:absolute; font-weight:bold;"><?php echo $plo['date'];?></div>

<div style="font-family:segoepr; margin:400px 0 0 135px; position:absolute; font-weight:bold;"><?php echo $plo['scode'].$plo['formno'].$plo['scode1'].$plo['Gserial'];;?></div>

<div style="font-family:segoepr; margin:442px 0 0 110px; position:absolute; font-weight:bold;"><?php echo $plo['name'];?></div>

<div class="head" style="font-family:segoepr; margin:482px 0 0 110px; position:absolute; font-weight:bold;"><?php echo $plo['cnic'];?></div>

<div class="head" style="font-family:segoepr; margin:522px 0 0 110px; position:absolute; font-weight:bold;">Royal Orchard Housing</div>

<div class="head" style="font-family:segoepr; margin:562px 0 0 110px; position:absolute; font-weight:bold;">Residential</div>
...
<div style="font-family:segoepr; margin:375px 0 0 245px; position:absolute; font-weight:bold;">18-12-2015</div>

<div style="font-family:segoepr; margin:375px 0 0 760px; position:absolute; font-weight:bold;"><?php echo $plo['scode'].$plo['formno'].$plo['scode1'].$plo['Gserial'];;?></div>

<div style="font-family:segoepr; margin:410px 0 0 245px; position:absolute; font-weight:bold;"><?php echo $plo['name'];?></div>

<div style="font-family:segoepr; margin:410px 0 0 680px; position:absolute; font-weight:bold;"><?php echo $plo['sodowo'];?></div>

<div style="font-family:segoepr; margin:450px 0 0 245px; position:absolute; font-weight:bold;"><?php echo $plo['cnic'];?></div>

<div style="font-family:segoepr; margin:450px 0 0 640px; position:absolute; font-weight:bold;">Royal Orchard Housing Projects</div>

<div style="font-family:segoepr; margin:488px 0 0 245px; position:absolute; font-weight:bold;">Residential</div>

<div style="font-family:segoepr; margin:550px 0 0 800px; position:absolute;"><?php //echo $plo['paidamount'];?></div>

<div style="font-family:segoepr; margin:750px 0 0 100px; position:absolute; font-size:9px;">Printed By: <?php echo $username.' ('.date('18-12-2015', time()).')';?></div>
...
'htmlOptions' => array('enctype' => 'multipart/form-data'),
  ...
  <select name="project_id" disabled="disabled" id="project" >
   ...
   <div class="float-left">
    ...
    <?php echo   ' <input  value="'.$plo['paidamount'].'" name="paidamount" id="paidamount" type="text" />';
