...
<div class="float-left">
 ...
 <input type="text" name="sector" readonly="readonly" id="sector" value="<?php echo $key['sector_name']?>" />
  ...
  <div class="float-left">
      ...
      <p class="reg-right-field-area margin-left-5">
         <input type="text" value="<?php echo $key['pcode'] ?>" name="procode" id="procode" class="reg-login-text-field" style="width:60px;"  readonly/>

      <input type="text" value="" name="plotno" id="plotno" class="reg-login-text-field" style="width:140px;" />
	<?php $type=''; if($key['com_res']=='Commercial'){$type='C';}else{$type='R';} ?>
...
<div class="float-left">
   ...
   <div class="float-left">
    ...
    <p class="reg-right-field-area margin-left-5">
     ...
     foreach($plan as $p)
	 {
	echo'<option value="'.$p['tno'].'">'.$p['tno'].'&nbsp;'.'Months'.'('.$p['description'].')</option>
';	 
