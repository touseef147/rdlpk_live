...
<script>	
 ...
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/recovery/wlist",
                  type:"POST",
...
Exceptional Case :<input type="checkbox" name="excp" value="1"/>
 <?php echo CHtml::ajaxSubmitButton(
                                'Search',

     array('recovery/wlist/?page=1'),
                                array(  
...
?>
  ...
  <div class="">
    ...
    <form method="post" action="removewlj">
