...
<form action="create" method="post"> 
  ...
  <div class="float-left">
    ...
    <thead style="background:#666; border-color:#ccc; color:#fff;"><tr><th width="8%">Membership #</th><th width="10%">Member Name</th><th width="8%">Size Category</th><th width="9%">Plot No</th><th width="10%">Street</th><th width="10%">Project</th><th width="7%">Action</th><tr></thead>
            ...
            echo '<tr><td>'.$key['plotno'].'</td><td>'.$key['name'].'</td></td><td>'.$key['size'].'</td><td>'.$key['plot_detail_address'].'</td><td>'.$key['street'].'</td><td>'.$key['project_name'].'</td><td><a href="req_detail?id='.$key['id'].'">View Request</a></td></tr>'; 
