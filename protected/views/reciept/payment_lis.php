...
<script>	
 ...
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/reciept/searchreq",
                  type:"POST",
...
<div class="shadow">
  ...
  <h3>Payment List</h3>
<div style="float:right;"><a href="Installment_lis"><h5>Installment List</h5> </a></div>
</div>
...
?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
    ...
    array('/reciept/searchreq/?page=1'),
