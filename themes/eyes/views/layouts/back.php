...
<div class="container-fluid"> 
 ...
 <li><a href="<?php echo $this->createAbsoluteUrl('plots/plots')?>" class="link-2" title="Plot">Plot</a></li>
   ...
   <?php if(Yii::app()->session['user_array']['per12']=='1'
		or Yii::app()->session['user_array']['per18']=='1'
		or Yii::app()->session['user_array']['per19']=='1'
		or Yii::app()->session['user_array']['per20']=='1'
		or Yii::app()->session['user_array']['per21']=='1'		 
		 ){  ?>
        <li><a href="#" class="link-2" title="Search">Sales</a>
          <ul class="sub-menu">
          <?php if(Yii::app()->session['user_array']['per18']=='1' or Yii::app()->session['user_array']['per19']=='1' or Yii::app()->session['user_array']['per20']=='1' or Yii::app()->session['user_array']['per21']=='1'){  ?>
            <li><a href="<?php echo $this->createAbsoluteUrl('reciept/reciept_lis')?>" class="link-2" title="Member Plot">Payments</a></li>
          <?php }
		  if(Yii::app()->session['user_array']['per19']=='1' or Yii::app()->session['user_array']['per21']=='1'){?>  
			   <li><a href="<?php echo $this->createAbsoluteUrl('reciept/dealers')?>" class="link-2" title="Plots">Dealers </a></li>
              <?php }
		   if(Yii::app()->session['user_array']['per12']=='1'){  ?>
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplotsales/transfer_lis')?>" class="link-2" title="Plots">Transfers</a></li>
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplotsales/allotments_lis')?>" class="link-2" title="File">Allotments</a></li>
          <?php }?>
          </ul>
        </li>
              |
        ...
        <li><a href="#" class="link-2" title="Search">Search</a>
          <ul class="sub-menu">
  <li><a href="<?php echo $this->createAbsoluteUrl('allotments/reslist?pid=1')?>" class="link-2" title="Plot">Search Balloting</a></li>
