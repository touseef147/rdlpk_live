...
<head>
 ...
 <title>Royal Developers & Builder</title>
...
<a href="<?php echo $this->createAbsoluteUrl('user/dashboard');?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo1.png" /></a>
...
<span>Welcome <?php echo Yii::app()->session['user_array']['firstname'].'&nbsp;'.Yii::app()->session['user_array']['middelname'].'&nbsp;'.Yii::app()->session['user_array']['lastname']?>!</span>
...
<a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/user-icon.png" /><?php echo Yii::app()->session['user_array']['username']?>  |</a>



<a href="<?php echo $this->createAbsoluteUrl('user/logout')?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/log-icon.png" />Logout</a>
...
<li><a href="#" class="link-2" title="Plots">Add</a>
...
<li><a href="<?php echo $this->createAbsoluteUrl('centers/centers')?>" class="link-2" title="category">Sales Center</a></li>
...
<li><a href="#" class="link-2" title="Projects">Allotment </a>
...
<li><a href="#" class="link-2" title="Projects">Search</a>
...
<li><a href="" class="link-2" title="Projects">Content</a>
...
$sql_projects  = "SELECT * from transferplot where status='newrequest'";
...
<li><a href="<?php echo $this->createAbsoluteUrl('user/req_list')?>" class="link-2" title="Projects">Transfer Plots<span style=" background-color: #FF0000;border-radius: 3px;padding: 3px 5px;vertical-align: super;"><?php echo $count; ?></span> </a>

<ul class="sub-menu">

<li><a href="<?php echo $this->createAbsoluteUrl('user/rej_req_list')?>" class="link-2" title="Projects">Rejected Request</a></li>

<li><a href="<?php echo $this->createAbsoluteUrl('user/pend_req_list')?>" class="link-2" title="Projects">Pending Request</a></li>

<li><a href="<?php echo $this->createAbsoluteUrl('user/appro_req_list')?>" class="link-2" title="Projects">Approved Request</a></li>
...
<li><a href="#" class="link-2" title="Plots">Add Media</a>

<ul class="sub-menu">

<li><a href="<?php echo $this->createAbsoluteUrl('news/news')?>" class="link-2" title="Streets">News/Events</a></li>

<li><a href="<?php echo $this->createAbsoluteUrl('gallery/gallery')?>" class="link-2" title="Streets">Image Gallery</a></li>



<li><a href="<?php echo $this->createAbsoluteUrl('user/virtual_tour_upload_video')?>" class="link-2" title="Streets">Virtual Tour</a></li>
